...
class ReceitasBrasileiras extends StatelessWidget {
  final List<String> brazilianRecipes = [
    "Feijoada",
    "Moqueca",
    "Pão de Queijo",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Receitas Brasileiras'),
      ),
      body: ListView(
        children: _buildRecipeCards(brazilianRecipes),
      ),
    );
  }
